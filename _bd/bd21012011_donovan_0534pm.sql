...
insert  into `distributions`(`id`,`deliveryDate`,`state`,`companies_id`,`warehouses_id`,`createdAt`,`deletedAt`) values (1,'2011-01-11',1,555555,3,'0000-00-00 00:00:00',NULL),(2,'2011-01-11',1,555555,3,'0000-00-00 00:00:00',NULL),(3,'2011-01-11',1,555555,3,'0000-00-00 00:00:00',NULL),(4,'2011-01-11',1,555555,3,'0000-00-00 00:00:00',NULL),(5,'2011-01-11',1,555555,3,'0000-00-00 00:00:00',NULL),(6,'2011-01-11',1,555555,3,'0000-00-00 00:00:00',NULL),(7,'2011-01-11',1,555555,3,'0000-00-00 00:00:00',NULL),(8,'2011-01-11',1,555555,3,'0000-00-00 00:00:00',NULL),(9,'2011-01-12',1,555555,3,'0000-00-00 00:00:00',NULL),(10,'2011-01-11',1,555555,3,'0000-00-00 00:00:00',NULL),(11,'2011-01-12',1,555555,3,'0000-00-00 00:00:00',NULL),(12,'2011-01-13',1,555555,3,'0000-00-00 00:00:00','2011-01-21 15:43:00'),(13,'2011-01-12',1,555555,3,'0000-00-00 00:00:00',NULL),(14,'2011-01-12',1,555555,3,'0000-00-00 00:00:00',NULL);
...
insert  into `donations`(`sequence`,`detail`,`bill`,`users_id`,`donors_id`,`warehouses_id`,`companies_id`,`date`,`createdAt`,`deletedAt`) values (8,NULL,NULL,1,111,3,NULL,'2011-01-21 00:00:00','2011-01-21 15:48:28',NULL);
...
insert  into `kits`(`id`,`name`,`createdAt`,`deletedAt`) values (2,'Kit 2','0000-00-00 00:00:00',NULL),(6,'PRueba','0000-00-00 00:00:00','0000-00-00 00:00:00');
...
insert  into `products_donations`(`products_id`,`donations_id`,`expirationDate`,`state`,`id`,`warehouses_id`,`createdAt`,`deletedAt`) values (5,1,'2011-01-12',4,2,7,'0000-00-00 00:00:00',NULL),(5,1,'2011-01-12',6,3,3,'0000-00-00 00:00:00',NULL),(5,1,'2011-01-12',2,4,3,'0000-00-00 00:00:00',NULL),(3,1,'2011-01-12',6,5,3,'0000-00-00 00:00:00',NULL),(2,1,'2011-01-12',4,6,7,'0000-00-00 00:00:00',NULL),(4,7,'2011-01-25',1,7,3,'0000-00-00 00:00:00',NULL),(5,8,'2011-01-28',1,8,3,'2011-01-21 15:48:51',NULL),(3,8,'2011-01-31',1,9,3,'2011-01-21 15:49:06',NULL),(3,8,'2011-01-31',1,10,3,'2011-01-21 15:49:06',NULL),(3,8,'2011-01-31',1,11,3,'2011-01-21 15:49:06',NULL);
...
insert  into `products_donations_distributions`(`distributions_id`,`products_donations_id`,`createdAt`,`deletedAt`) values (9,2,'0000-00-00 00:00:00',NULL),(9,3,'0000-00-00 00:00:00',NULL),(10,2,'0000-00-00 00:00:00',NULL),(11,3,'0000-00-00 00:00:00',NULL),(12,2,'0000-00-00 00:00:00','2011-01-21 15:43:00'),(12,6,'0000-00-00 00:00:00','2011-01-21 15:43:00');

/*Table structure for table `products_donations_transfers` */

DROP TABLE IF EXISTS `products_donations_transfers`;

CREATE TABLE `products_donations_transfers` (
  `product_donation_id` int(11) DEFAULT NULL,
  `transfers_id` int(11) DEFAULT NULL,
  `quantity` int(11) DEFAULT NULL,
  `deletedAt` datetime DEFAULT NULL,
  KEY `FK_products_donations_tranfers` (`transfers_id`),
  ...
  CONSTRAINT `FK_products_donations_transfers` FOREIGN KEY (`transfers_id`) REFERENCES `transfers` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `products_donations_transfers` */
...
insert  into `statechanges`(`reason`,`notes`,`previousState`,`currentState`,`users_id`,`products_donations_id`,`createdAt`,`deletedAt`,`id`) values ('Ingreso a la bodega 3',NULL,0,1,1,8,'2011-01-21 15:48:51',NULL,1),('Ingreso a la bodega 3',NULL,0,1,1,9,'2011-01-21 15:49:06',NULL,2),('Ingreso a la bodega 3',NULL,0,1,1,10,'2011-01-21 15:49:06',NULL,3),('Ingreso a la bodega 3',NULL,0,1,1,11,'2011-01-21 15:49:06',NULL,4),('Eliminado por el usuario $_SESSION[dms_id]',NULL,2,6,1,5,'2011-01-21 16:02:56',NULL,5),('Eliminado por el usuario $_SESSION[dms_id]',NULL,2,6,1,3,'2011-01-21 16:02:56',NULL,6),('Eliminado por el usuario $_SESSION[dms_id]',NULL,6,6,1,3,'2011-01-21 16:02:56',NULL,7),('Eliminado por el usuario $_SESSION[dms_id]',NULL,6,6,1,3,'2011-01-21 16:02:57',NULL,8),('Eliminado por el usuario 1',NULL,6,6,1,5,'2011-01-21 16:11:43',NULL,9),('Eliminado por el usuario 1',NULL,6,6,1,3,'2011-01-21 16:11:43',NULL,10),('Eliminado por el usuario 1',NULL,6,6,1,3,'2011-01-21 16:11:43',NULL,11),('Eliminado por el usuario 1',NULL,6,6,1,3,'2011-01-21 16:11:43',NULL,12);
...
insert  into `users`(`id`,`name`,`email`,`phoneNumber`,`profile`,`password`,`createdAt`,`deletedAt`,`companies_id`) values (1,'Admin','support@coddeeweb.com',NULL,'Operador','e11a8f5f22179a6485f5ef8d1fa59003','0000-00-00 00:00:00',NULL,NULL);
