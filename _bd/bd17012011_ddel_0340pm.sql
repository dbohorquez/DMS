...
insert  into `categories`(`id`,`name`,`description`,`deletedAt`) values (1,'Productos de Aseo de Ropa','Diferentes productos de aseo para la ropa',NULL),(2,'comida','comida',NULL);
...
insert  into `producttypes`(`id`,`name`,`description`,`createdAt`,`deletedAt`,`categories_id`) values (1,'Aceite','Aceite en sus diversas presentaciones','0000-00-00 00:00:00',NULL,0),(3,'Mesa','Todo tipo de mesas','0000-00-00 00:00:00',NULL,0),(4,'ColchÃ³n','Multiples variedades de colchones','0000-00-00 00:00:00',NULL,0),(5,'AtÃºn','Atunes en lata','0000-00-00 00:00:00',NULL,0),(6,'Camaron','Camaron de agua dulce','2011-01-17 15:15:05',NULL,2),(7,'dfdsfds','dsfdsfs','2011-01-17 15:28:00',NULL,1);
...
insert  into `users`(`id`,`name`,`email`,`phoneNumber`,`profile`,`password`,`createdAt`,`deletedAt`) values (1,'Admin','support@coddeeweb.com',NULL,'Administrador','e11a8f5f22179a6485f5ef8d1fa59003','0000-00-00 00:00:00',NULL);
...
insert  into `warehouses`(`id`,`name`,`description`,`type`,`occupation`,`contactName`,`address`,`phoneNumber`,`cellphone`,`faxNumber`,`towns_id`,`createdAt`,`deleteAt`) values (3,'GobernaciÃ³n','bodega',2,20,'Jorge Arango','Calle falsa 123','43243','432332','3423432',1,'0000-00-00 00:00:00',NULL),(7,'kjdfasj','jsjdfaskjdnajdn',1,20,'ns anmsd jsnda','sdsada','332432','324233','32432234',1,'0000-00-00 00:00:00',NULL);
